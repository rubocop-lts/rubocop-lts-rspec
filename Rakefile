...
# rubocop-lts-rspec Rakefile v7.0.0 - 2026-06-19
...
# rake install                                # Build and install rubocop-lts-rspec-1.0.0.gem in...
# rake install:local                          # Build and install rubocop-lts-rspec-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rubocop-lts-rspec against itse...
