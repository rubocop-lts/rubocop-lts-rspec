...
# kettle-jem:freeze
# To retain chunks of comments & code during rubocop-lts-rspec templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rubocop-lts-rspec will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
