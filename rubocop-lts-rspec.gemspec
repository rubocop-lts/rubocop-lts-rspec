...
Gem::Specification.new do |spec|
  spec.name = "rubocop-lts-rspec"
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/lts/rspec/version.rb", mod) }::Rubocop::Lts::Rspec::Version::VERSION
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-lts-rspec.galtzo.com"
  ...
  # Utilities
  spec.add_dependency("rubocop", "~> 1.84", ">= 1.84.2") # Ruby >= 2.7.0
  spec.add_dependency("rubocop-env", "~> 0.1", ">= 0.1.0") # Ruby >= 2.5
  spec.add_dependency("rubocop-factory_bot", "~> 2.28", ">= 2.28.0") # Ruby >= 2.7.0
  spec.add_dependency("rubocop-rspec", "~> 3.9", ">= 3.9.0") # Ruby >= 2.7.0
  ...
  # The 'git' gem is optional; rubocop-lts-rspec falls back to shelling out to `git` if it is not present.
